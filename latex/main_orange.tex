...
\node[inner sep=0pt] (background) at (current page.center) {\includegraphics[width=\paperwidth]{cover_picture.pdf}};
...
{\large Version: 1.0 \ \ \ \ Contact: I.Vivarelli@sussex.ac.uk}\\[20pt] % Subtitle
