...
\title{	
	\normalfont\normalsize
	\textsc{Physics and Astronomy Department - University of Sussex}\\ % Your university, school and/or department name(s)
	\vspace{25pt} % Whitespace
	\rule{\linewidth}{0.5pt}\\ % Thin top horizontal rule
	\vspace{20pt} % Whitespace
	{\huge Collider Physics using ATLAS Open Data}\\ % The assignment title
	\vspace{0.5cm}
...
\author{\large Prepared by Iacopo Vivarelli} % Your name
...
\input{tex/particle_physics}

\section{ATLAS and its Open Data}
\input{tex/ATLAS_OpenData}

\section{Software Tools}
\input{tex/software_tools}
